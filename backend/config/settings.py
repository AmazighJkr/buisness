...
PAYMENT_STRIPE_FEE_PERCENT = float(os.getenv('PAYMENT_STRIPE_FEE_PERCENT', '2.9'))
PAYMENT_STRIPE_FEE_FIXED_USD = float(os.getenv('PAYMENT_STRIPE_FEE_FIXED_USD', '0.30'))
PAYMENT_CHARGILY_FEE_PERCENT = float(os.getenv('PAYMENT_CHARGILY_FEE_PERCENT', '2.5'))
