...
from .views import (
    ...
    AdminStoreCommentDetailView,
    AdminStoreCommentListView,
    AdminCommandViewSet,
    CommandInvoicePdfView,
...
urlpatterns = [
    ...
    path('store/orders/invoice/', StoreOrderInvoiceView.as_view(), name='store-order-invoice'),
    ...
    path('commands/invoices/<uuid:invoice_id>/pdf/', CommandInvoicePdfView.as_view(), name='command-invoice-pdf'),
    ...
    path('auth/me/orders/', CustomerOrdersOverviewView.as_view(), name='auth-me-orders'),
    ...
    path('admin/comments/<uuid:id>/', AdminCommentDetailView.as_view(), name='admin-comment-detail'),
    path('admin/store/comments/', AdminStoreCommentListView.as_view(), name='admin-store-comment-list'),
    path('admin/store/comments/<uuid:id>/', AdminStoreCommentDetailView.as_view(), name='admin-store-comment-detail'),
    path(
